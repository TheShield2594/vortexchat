...
34. ~~Kicked user loses realtime access instantly — ⚠️ — Ban removes from server_members; Supabase RLS should revoke access; whether active Real~~time subscriptions terminate immediately untested — Fix: authz checks in subscriptions + force-disconnect on ban/kick.~~
