...
export function getShortcutRegistry(handlers: ShortcutHandlers): ShortcutDefinition[] {
  return [
    ...
    { id: "markAllServerRead", label: "Mark All Channels Read", group: "Navigation", scope: "nonInput", combos: ["shift+escape"], enabled: !!handlers.onMarkAllServerRead, run: handlers.onMarkAllServerRead },
