...
export function VortexLogo({ size = 32, className, style }: VortexLogoProps) {
  ...
  return (
    ...
    >
      ...
      <ellipse cx="262" cy="108" rx="128" ry="52" fill={`url(#${gradId})`} />
      ...
      {/* Horizontal bands */}
      <path d="M 106 182 C 172 166, 340 166, 406 182 C 340 198, 172 198, 106 182 Z" fill={`url(#${gradId})`} opacity="0.95" />
      <path d="M 144 228 C 200 214, 312 214, 368 228 C 312 242, 200 242, 144 228 Z" fill={`url(#${gradId})`} opacity="0.85" />
      <path d="M 178 270 C 222 258, 290 258, 334 270 C 290 282, 222 282, 178 270 Z" fill={`url(#${gradId})`} opacity="0.75" />
      <path d="M 208 308 C 236 298, 276 298, 304 308 C 276 318, 236 318, 208 308 Z" fill={`url(#${gradId})`} opacity="0.65" />
